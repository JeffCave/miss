...
(function(){
	...
	loader.realLoad([
			...
			,'scripts/preprocessor/SubmissionPreprocessor.js'
			...
			,'scripts/preprocessor/PreprocessorRegistry.js'

			,'scripts/preprocessor/CommonCodeLineRemovalPreprocessor.js'
			,'scripts/preprocessor/LowercasePreprocessor.js'
			,'scripts/preprocessor/PreprocessSubmissions.js'
			,'scripts/preprocessor/WhitespaceDeduplicationPreprocessor.js'
